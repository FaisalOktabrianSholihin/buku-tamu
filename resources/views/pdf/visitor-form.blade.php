...
<body>
    ...
    <div style="margin-bottom: 10px;">
        <table style="width: 100%; border: 2px solid black; border-collapse: collapse;">
            <tr>
                {{-- KOLOM KIRI: LOGO --}}
                <td
                    style="width: 30%; text-align: center; border-right: 2px solid black; vertical-align: middle; padding: 10px;">
                    {{-- 
                        CATATAN: Jika gambar tidak muncul (tanda silang merah/kosong) saat di-export,
                        Ganti {{ asset(...) }} menjadi {{ public_path(...) }} 
                    --}}
                    <img src="{{ public_path('images/logo-kunjunganku.png') }}" style="max-width: 100px; height: auto;">
                </td>
                ...
                <td style="width: 70%; padding: 0; vertical-align: top;">
                    <table style="width: 100%; border-collapse: collapse; margin: 0;">
                        ...
                        <tr>
                            <td colspan="2"
                                style="text-align: center; font-weight: bold; font-size: 16px; padding: 15px 5px; border-bottom: 2px solid black; border-right: none; border-left: none; border-top: none;">
                        ...
                        <tr>
                            <td
                                style="width: 60%; text-align: center; font-weight: bold; border-bottom: 2px solid black; border-right: 2px solid black; padding: 5px;">
                                VISITOR CONTROL
                            </td>
                            <td style="width: 40%; padding: 5px; border-bottom: 2px solid black;">
                                NO REV: 05
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align: center; border-right: 2px solid black; padding: 5px;">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="2">{{ $tamu->instansi }}</td>
        </tr>
        <tr>
            <td class="label-col">2. BIDANG USAHA</td>
            <td colspan="2">{{ $tamu->bidang_usaha }}</td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2">{{ $tamu->jumlah_tamu }} Orang</td>
        </tr>
        ...
        @foreach ($tamu->pengiring as $index => $pengiring)
            <tr>
                <td>{{ $index + 2 }}.</td>
                <td>{{ $pengiring->nama }} ({{ $pengiring->jabatan }})</td>
            </tr>
        @endforeach
        ...
        <tr>
            ...
            <td colspan="2">{{ $tamu->created_at->format('d/m/Y / H:i') }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="label-col">9. AGENDA / KEPERLUAN</td>
